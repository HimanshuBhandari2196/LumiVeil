...
- Fact-checking pipeline — Google Fact Check API first, falls back to Gemini 2.5 Flash with Google Search grounding
...
- **Fact-checking** — Google Fact Check API, with Gemini 2.5 Flash (Google Search grounding) as a fallback
